...
\begin{tabular}{ |C{1cm}|c|c|c| }
 \hline
 $\mathbf{R}$ & $\mathbf{Y_{lm}}$ & $\mathbf{^{2S+1}L_g}$ & $\mathbf{^{2S+1}L_u}$ \\[1.5ex]
 \hline\hline
...
\[ \sum\limits_{i=1}^{n} i = \dfrac{n(n+1)}{2}= \dfrac{a_1+a_n}{2}\,n;\quad
 ...
 \sum\limits_{i=0}^{n} a^{\,i} = \dfrac{a^{n+1}-1}{a-1};\] \vspace{1.5mm}
...
\[ \sin(\alpha\,+\,\pi)=-\sin\alpha; \quad \cos(\alpha\,+\,\pi)=-\cos\alpha; \] \vspace{0.1mm}
...
\[ \ctg (\alpha\,+\,\beta)=\dfrac{\ctg \alpha\cdot \ctg \beta\,-\,1}{\ctg \alpha\,+\,\ctg \beta}; \quad \ctg (\alpha\,-\,\beta)=\dfrac{\ctg \alpha\cdot \ctg \beta\,+\,1}{\ctg \beta\,-\,\ctg \alpha}; \] \vspace{0.1mm}
...
\hline\hline
\renewcommand{\arraystretch}{1.5} \begin{tabular}{@{}c@{}}  $E_4=\alpha-1\text{,}618\beta$ \\ $\psi_4=a\phi_1-b\phi_2+b\phi_3-a\phi_4$ \end{tabular} & \renewcommand{\arraystretch}{1.5} \begin{tabular}{@{}c@{}}  $E_5=\alpha-\sqrt{3}\beta$ \\ $\psi_5=\dfrac{1}{\sqrt{12}}(\phi_1-\sqrt{3}\phi_2+2\phi_3-\sqrt{3}\phi_4+\phi_5)$ \end{tabular} \\[4ex]
\hline
\renewcommand{\arraystretch}{1.5} \begin{tabular}{@{}c@{}}  $E_3=\alpha-0\text{,}618\beta$ \\ $\psi_3=b\phi_1-a\phi_2-a\phi_3+b\phi_4$ \end{tabular} & \renewcommand{\arraystretch}{1.5} \begin{tabular}{@{}c@{}}  $E_4=\alpha-\beta$ \\ $\psi_4=\dfrac{1}{{2}}(\phi_1-\phi_2+\phi_4-\phi_5)$ \end{tabular} \\[4ex]
\hline
\renewcommand{\arraystretch}{1.5} \begin{tabular}{@{}c@{}}  $E_2=\alpha+0\text{,}618\beta$ \\ $\psi_2=b\phi_1+a\phi_2-a\phi_3-b\phi_4$ \end{tabular} & \renewcommand{\arraystretch}{1.5} \begin{tabular}{@{}c@{}}  $E_3=\alpha$ \\ $\psi_3=\dfrac{1}{\sqrt{3}}(\phi_1-\phi_3+\phi_5)$ \end{tabular}\\[4ex]
\hline
\renewcommand{\arraystretch}{1.5} \begin{tabular}{@{}c@{}}  $E_1=\alpha+1\text{,}618\beta$ \\ $\psi_1=a\phi_1+b\phi_2+b\phi_3+a\phi_4$ \end{tabular} & \renewcommand{\arraystretch}{1.5} \begin{tabular}{@{}c@{}}  $E_2=\alpha+\beta$ \\ $\psi_2=\dfrac{1}{{2}}(\phi_1+\phi_2-\phi_4-\phi_5)$ \end{tabular} \\[4ex]
\hline
 $a = 0\text{,}372;\ $ $b=0\text{,}602$ & \renewcommand{\arraystretch}{1.5} \begin{tabular}{@{}c@{}}  $E_1=\alpha+\sqrt{3}\beta$ \\ $\psi_1=\dfrac{1}{\sqrt{12}}(\phi_1+\sqrt{3}\phi_2+2\phi_3+\sqrt{3}\phi_4+\phi_5)$ \end{tabular}  \\[4ex]
\hline
\end{tabular}
\end{center}
...
\vspace{1mm}
\begin{tabular}{ c c }
$E_k=\alpha +2\beta\cos{\dfrac{2\pi k}{n}}$ & $k=0,\,1,\,\ldots\,n-1 $ \\[2ex]
$\psi_k=\sqrt{\dfrac{1}{n}}\,\mathlarger{\mathlarger{\sum}}\limits_{p=1}^{n} \cos\left({\dfrac{2\pi p k}{n}}\right)\phi_p$ &  \begin{tabular}{ c c }  $k=0$ & $n=2i+1$ \\[0ex] $ k=0,\,\dfrac{n}{2}$ & $n=2i$ \end{tabular} \\[5ex]
$\psi_k=\sqrt{\dfrac{2}{n}}\,\mathlarger{\mathlarger{\sum}}\limits_{p=1}^{n} \cos\left({\dfrac{2\pi p k}{n}}\right)\phi_p$ &  \begin{tabular}{ c c }  $k=1,\,2,\,\ldots \dfrac{n-1}{2}$ & $n=2i+1$ \\[1ex] $k=1,\,2,\,\ldots \dfrac{n-2}{2}$ & $n=2i$ \end{tabular} \\[5ex]
$\xi_k=\sqrt{\dfrac{2}{n}}\,\mathlarger{\mathlarger{\sum}}\limits_{p=1}^{n} \sin\left({\dfrac{2\pi p k}{n}}\right)\phi_p$ &  \begin{tabular}{ c c }  $k=1,\,2,\,\ldots \dfrac{n-1}{2}$ & $n=2i+1$ \\[1ex] $k=1,\,2,\,\ldots \dfrac{n-2}{2}$ & $n=2i$ \end{tabular} \\[5ex]
\end{tabular}
...
$\psi_k=\sqrt{\dfrac{2}{n+1}}\,\mathlarger{\mathlarger{\sum}}\limits_{p=1}^{n} \sin\left({\dfrac{\pi p k}{n+1}}\right)\phi_p$ & $k=1,\,2,\,\ldots\,n $  \\[5ex]
\end{tabular}
...
2) $\pi$-заряд на всех центрах альтернантной системы равен 1.
