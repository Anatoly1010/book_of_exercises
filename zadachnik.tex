...
\frontmatter
% Include the cover, which is located in the FrontMatter subfolder.
...
\input{./MainMatter/Chapter_1.1}
\input{./MainMatter/Chapter_1.2}
\input{./MainMatter/Chapter_1.3}
\input{./MainMatter/Chapter_1.4}
\input{./MainMatter/Chapter_1.5}
\input{./MainMatter/Chapter_1.6}
\input{./MainMatter/Chapter_1.7}
\input{./MainMatter/Chapter_1.8}
\input{./MainMatter/Chapter_1.9}
...
\input{./MainMatter/Chapter_2.1}
\input{./MainMatter/Chapter_2.2}
\input{./MainMatter/Chapter_2.3}
\input{./MainMatter/Chapter_2.4}
\input{./MainMatter/Chapter_2.5}
\input{./MainMatter/Chapter_2.6}
\input{./MainMatter/Chapter_2.7}
\input{./MainMatter/Chapter_2.8}
\input{./MainMatter/Chapter_2.9}

\chapter[Список теоретических вопросов]{Список теоретических вопросов}
\thispagestyle{empty}

\input{./BackMatter/Theory}
...
\thispagestyle{empty}
\include{./BackMatter/spavochnik1}
